    ...
    return (
        <nav className="navbar navbar-expand-lg bg-light">
            <div className="container-fluid">
                <Link className="navbar-brand" to="/"><img src="favicon.webp" style={{ width: '27px', height: '27px', transform: 'translateY(-5px)' }} alt='logo' /><b> Fair Online Delivery Service Review</b></Link>
