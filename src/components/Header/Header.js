    ...
    return (
        <nav className="navbar navbar-expand-lg bg-light">
            <div className="container-fluid">
                <Link className="navbar-brand" to="/"><img src="favicon.webp" style={{ width: '27px', height: '27px', transform: 'translateY(-5px)' }} alt='logo' /><b style={{ fontSize: '21px' }}> Crimson Review</b></Link>
                        ...
                        <Link className="nav-link text-black" to="/blog"><h5>Blog</h5></Link>
                        {
                            user?.uid ?
                                <>
                                    ...
                                    <Link className="nav-link text-black" to='/allreviews'><h5>All Reviews</h5></Link>
